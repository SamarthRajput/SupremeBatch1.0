...
int solveUsingTabulation(int weight[], int value[], int n, int capacity) {
  vector<vector<int> > dp(n, vector<int>(capacity+1 , 0)); //iss 2d dp vector ko dhyaan se size dena or initialise karna hai
  ...
  //iss return statement me galti ho sakti hai
...
int solveUsingSO2(int weight[], int value[], int n, int capacity) {
  ...
  for(int index=1; index<n; index++) {
    //iss for loop me galti ho sakti hai
